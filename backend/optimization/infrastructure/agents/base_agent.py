...
#   - Template method: run() orchestrates prepare -> execute -> parse_output
#   - Error handling: wrap exceptions with agent-specific context
#   - Logging: log each phase with structured logging
